...
namespace Anonymous\SymBlogBundle\Tests\Entity\Repository;

use Anonymous\SymBlogBundle\Entity\Repository\BlogRepository;
use Symfony\Bundle\FrameworkBundle\Test\WebTestCase;

class BlogRepositoryTest extends WebTestCase {

    /**
     * @var \Anonymous\SymBlogBundle\Entity\Repository\BlogRepository
     */
    ...
    public function setUp() {
        ...
        $this->blogRepository = $kernel->getContainer()
                                       ...
                                       ->getRepository('AnonymousSymBlogBundle:Blog');
    }
