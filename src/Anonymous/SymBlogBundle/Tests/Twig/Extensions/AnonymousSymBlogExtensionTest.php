...
namespace Anonymous\SymBlogBundle\Tests\Twig\Extensions;

use Anonymous\SymBlogBundle\Twig\Extensions\AnonymousSymBlogExtension;

class AnonymousSymBlogExtensionTest extends \PHPUnit_Framework_TestCase {

    public function testCreatedAgo() {
        $blog = new AnonymousSymBlogExtension();
